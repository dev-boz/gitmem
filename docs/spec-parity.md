...
| `eval` | `l2-review(--cases,--case,--min-pass-rate)`, `inject(--cases,--case,--min-pass-rate,--disclosure-slack-pct)` | `umx/cli.py:1273-1334` | Documented | On-demand eval harnesses for governance review and inject/retrieval ranking drift. |
